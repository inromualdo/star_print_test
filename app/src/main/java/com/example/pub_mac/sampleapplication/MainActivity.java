...
//        Typeface typeface = Typeface.create(Typeface.MONOSPACE, Typeface.NORMAL);
    ...
    public boolean printTicket(Context context, String strPrintArea, Ticket myticket, StarMicronicsPrinterListener listener) {
//        ICommandBuilder = StarIoExt.createCommandBuilder()
